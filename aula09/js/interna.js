...
function tratarResposta(res){
    if (res.status == 200){
        ...
        document.getElementById("dadosAnuncio").innerHTML = "Usuario nao encontrado"
    )
}
function exibirDados(dados){
    let anuncios = dados.anuncios;
    let tabela = "<table> <tr> <th>Id</th> <th>Descricao</th> <th>Valor</th> </tr>"

    if(anuncios.length == 0){
    document.getElementById("dadosAnuncio").innerHTML = "Usuario nao possui anuncios"
    }else{
